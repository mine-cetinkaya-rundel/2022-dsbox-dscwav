...
author: "[datasciencebox.org](https://datasciencebox.org/) <br> [bit.ly/dsbox-dscwav-dataviz](https://bit.ly/dsbox-dscwav-dataviz)"
output:
...
.your-turn[
- Go to [rstd.io/dsbox-cloud](https://rstd.io/dsbox-cloud) to join RStudio Cloud (you'll need to log in with Google, GitHub, or shinyapps.io account or create an account).

- Click on Projects on top.

- Start the project titled `AE 03 - StarWars + Data visualisation`.

- Let's work on Exercises 1 and 2 together. Then, complete Exercise 3 yourself.
]
...
.your-turn[
- Go back to `AE 03 - StarWars + Data visualisation` on RStudio Cloud.

- Work on Exercises 4 and 5, compare notes with your neighbor.

<br>

**Missed earlier instructions?** Go to [rstd.io/dsbox-cloud](https://rstd.io/dsbox-cloud) to join RStudio Cloud (you'll need to log in with Google, GitHub, or shinyapps.io account or create an account). Click on Projects on top. Start the project titled `AE 03 - StarWars + Data visualisation`.
]
...
- Work on Exercises 6 and 7, compare notes with your neighbor.
...
- Work on Exercise 8, compare notes with your neighbor.
